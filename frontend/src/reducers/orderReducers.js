import {
  ...
  ORDER_ORDERS_LIST_REQUEST,
  ORDER_ORDERS_LIST_SUCCESS,
  ORDER_ORDERS_LIST_FAIL,
  ORDER_ORDERS_LIST_RESET,
...
export const orderListReducer = (state = { orders: [] }, action) => {
  switch (action.type) {
    case ORDER_ORDERS_LIST_REQUEST:
      return {
        loading: true,
      };
    case ORDER_ORDERS_LIST_SUCCESS:
      return {
        loading: false,
        orders: action.payload,
      };

    case ORDER_ORDERS_LIST_FAIL:
      return {
        loading: false,
        error: action.payload,
      };
